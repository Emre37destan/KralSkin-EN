			...
			while (true) {
				...
				if (gameState) {
					...
					if (cheatState) {
						...
						this->label2->Text = L"Waiting for the Injection!";
						this->label2->ForeColor = System::Drawing::Color::FromArgb(255, 245, 8, 83);
					}
				} else {
					this->label3->Text = L"Waiting!";
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Text = L"Inject Status";
			// 
			// groupBox2
			// 
			...
			this->groupBox2->Text = L"Client Status";
			// 
			// label4
			// 
			...
			this->groupBox3->Text = L"Game Status";
			// 
			// groupBox4
			// 
			...
			this->groupBox4->Text = L"KingSkin Status";
			// 
			// linkLabel1
			// 
			...
			this->linkLabel1->Text = L"Copyright (c) 2022 = King";
...
#pragma endregion
	...
	private:
		System::Void button1_Click(System::Object^ sender, System::EventArgs^ e)
		{
			...
			if (btnState) {
				...
				this->label1->Text = L"It's working!";
			} else {
	...
	private:
		...
		{
			System::Diagnostics::Process::Start(L"https://github.com/Emre37destan/KralSkin-EN");
		}
	};
}
